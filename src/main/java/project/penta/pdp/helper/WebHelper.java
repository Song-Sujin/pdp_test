package project.penta.pdp.helper;
...
public class WebHelper
{
	...
	/*
	 * 전달받은 Map객체에 rt와 pubData값을 추가한 후 리턴한다.
	 * 
	...
	public Map<String, Object> getJsonData(int statusCode, String rt, Map<String, Object> data)
	{
		...
		// Ajax 요청에 대한 크로스 도메인 허용 처리
		
		// 2) 파라미터로 전달된 Map 객체에 rt와 pubData값을 추가한 새로운 Map 생성하기
