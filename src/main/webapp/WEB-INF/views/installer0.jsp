...
<body>
    ...
    <nav id="sidebar" class="">
      ...
      <ul class="list-unstyled components mb-5">
        ...
        <li>
          <a href="#" class="disable"> 1. Select Version</a>
        </li>
        <li>
    ...
    <div id="content" class="p-3 p-md-5">
      <form method="post" action="${pageContext.request.contextPath }/installer0.do">
      <div class="" style="height:90%;">

        <h2 class="mb-4">Install Page</h2>
        <p>This wizrd will walk you through the cluster installation process. First, start by naming your new cluster.</p>

		
        <div class="card">
          <div class="card-header">
            <b>Name your Cluster</b>
          </div>
          <div class="card-body">

            <div class="input-group mb-3">
              <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="CLUSTER NAME">
            </div>
