...
<body>
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-3 p-md-5">
      <form method="post" action="${pageContext.request.contextPath }/installer3.do">
      <div class="" style="height:90%;">

        <h2 class="mb-4">Confirm Hosts</h2>
        <div class="">
          Registering your hosts
        </div>
        <p>
          Please confirm the host lists and remove any hosts that you do not want to include in the cluster.
        </p>
                ...
                <tr>
                  <th scope="row">
                    <div class="form-check form-check-inline">
                      ...
                      <label class="form-check-label" for="inlineCheckbox1">original.localdomain</label>
                    </div>
                  </th>
                  <td>
                    <div class="progress">
